...
set nonumber
set splitbelow "êVÇµÇ¢ÉEÉBÉìÉhÉEÇâ∫Ç…äJÇ≠
set splitright "êVÇµÇ¢ÉEÉBÉìÉhÉEÇâEÇ…äJÇ≠
...
"Filetype indent {{{
if has("autocmd")
    "ÉtÉ@ÉCÉãÉ^ÉCÉvÇÃåüçıÇóLå¯Ç…Ç∑ÇÈ
    filetype plugin on
    "ÇªÇÃÉtÉ@ÉCÉãÉ^ÉCÉvÇ…Ç†ÇÌÇπÇΩÉCÉìÉfÉìÉgÇóòópÇ∑ÇÈ
    filetype indent on
...
if g:supports.loaded_neobundle
    ...
    function! s:bundle.hooks.on_source(bundle)
        ...
        "ÉfÉtÉHÉãÉgÇÃÉLÅ[É}ÉbÉsÉìÉOÇïœçX
    ...
    "unite{{{2
    " ÉEÉBÉìÉhÉEÇï™äÑÇµÇƒäJÇ≠
    au FileType unite nnoremap <silent> <buffer> <expr> <C-J> unite#do_action('split')
    au FileType unite inoremap <silent> <buffer> <expr> <C-J> unite#do_action('split')
    " ÉEÉBÉìÉhÉEÇècÇ…ï™äÑÇµÇƒäJÇ≠
    au FileType unite nnoremap <silent> <buffer> <expr> <C-K> unite#do_action('vsplit')
    au FileType unite inoremap <silent> <buffer> <expr> <C-K> unite#do_action('vsplit')
    " ESCÉLÅ[Ç2âÒâüÇ∑Ç∆èIóπÇ∑ÇÈ
...
"}}}
    ...
    "èoóÕÇ…ëŒÇ∑ÇÈÉtÉBÉãÉ^ÅBç≈èâÇÃêîçsÇçÌèú
